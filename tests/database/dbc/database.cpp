...
#include "can/database/dbc/grammar/database.hpp"
...
static auto parse(auto input) {
    auto ast = lexy::parse<can::database::dbc::grammar::database>(input, lexy_ext::report_error);
    assert(ast.has_value());

    can::database::dbc::database::ptr db;
    try {
        db = can::database::dbc::database::from_ast(*ast.value());
...
static void test_simple_database() {
    ...
    assert(msg768_sig0->resolve_value(0) == "MODULE_1");
    assert(msg768_sig0->resolve_value(1) == "MODULE_2");
    assert(msg768_sig0->resolve_value(2) == "MODULE_3");
    assert(msg768_sig0->resolve_value(3) == "MODULE_4");
    assert(msg768_sig0->resolve_value(4) == "MODULE_5");
    assert(msg768_sig0->resolve_value(5) == "MODULE_6");
    assert(msg768_sig0->resolve_value(6) == "MODULE_7");
    assert(msg768_sig0->resolve_value(7) == "MODULE_8");
    ...
    assert(msg768_sig1->resolve_value(0) == "CHANNEL_1");
    assert(msg768_sig1->resolve_value(1) == "CHANNEL_2");
    assert(msg768_sig1->resolve_value(2) == "CHANNEL_3");
    assert(msg768_sig1->resolve_value(3) == "CHANNEL_4");
    assert(msg768_sig1->resolve_value(4) == "CHANNEL_5");
    assert(msg768_sig1->resolve_value(5) == "CHANNEL_6");
    assert(msg768_sig1->resolve_value(6) == "CHANNEL_7");
    assert(msg768_sig1->resolve_value(7) == "CHANNEL_8");
    assert(msg768_sig1->resolve_value(8) == "CHANNEL_9");
    assert(msg768_sig1->resolve_value(9) == "CHANNEL_10");
    assert(msg768_sig1->resolve_value(10) == "CHANNEL_11");
    assert(msg768_sig1->resolve_value(11) == "CHANNEL_12");
    assert(msg768_sig1->resolve_value(12) == "CHANNEL_13");
    assert(msg768_sig1->resolve_value(13) == "CHANNEL_14");
    assert(msg768_sig1->resolve_value(14) == "CHANNEL_15");
    assert(msg768_sig1->resolve_value(15) == "CHANNEL_16");
