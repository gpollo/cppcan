...
static auto parse(auto input) {
    return lexy::parse<can::database::dbc::grammar::description>(input, ignore_error);
}
...
static void test_node_description() {
    ...
    assert(std::holds_alternative<can::database::dbc::ast::node_description>(description));
    auto node_description = std::get<can::database::dbc::ast::node_description>(description);
...
static void test_message_description() {
    ...
    assert(std::holds_alternative<can::database::dbc::ast::message_description>(description));
    auto message_description = std::get<can::database::dbc::ast::message_description>(description);
...
static void test_signal_description() {
    ...
    assert(std::holds_alternative<can::database::dbc::ast::signal_description>(description));
    auto signal_description = std::get<can::database::dbc::ast::signal_description>(description);
...
static void test_database_description() {
    ...
    assert(std::holds_alternative<can::database::dbc::ast::database_description>(description));
    auto database_description = std::get<can::database::dbc::ast::database_description>(description);
