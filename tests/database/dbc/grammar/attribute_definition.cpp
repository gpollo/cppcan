...
static auto parse(auto input) {
    return lexy::parse<can::database::dbc::grammar::attribute_definition>(input, ignore_error);
}

using attribute_definition = can::database::dbc::ast::attribute_definition;
