...
static auto parse(auto input) {
    return lexy::parse<can::database::dbc::grammar::attribute>(input, ignore_error);
}

using db_attr   = can::database::dbc::ast::database_attribute;
using node_attr = can::database::dbc::ast::node_attribute;
using msg_attr  = can::database::dbc::ast::message_attribute;
using sig_attr  = can::database::dbc::ast::signal_attribute;
